...
'''
file1 = "./MT1k/test.txt"
    file2 = "./MT1k/entity2id.txt"
    file3 = "./MT1k/relation2id.txt"
    file4 = "./MT1k/valid.txt"
'''
def dataloader(file1, file2, file3, file4):
    ...
    with codecs.open(file1, 'r') as f:
        ...
        for line in content:
            ...
            # shoron changed order
            r_ = int(relations2id[triple[2]])
            t_ = int(entities2id[triple[1]])
...
if __name__ == '__main__':
    file_path = "./trial/"
    file1 = file_path + "train.txt"
    file2 = file_path + "entity2id.txt"
    file3 = file_path + "relation2id.txt"
    file4 = file_path + "valid.txt"
    ...
    file5 = file_path + "entity_50dim_batch75"
    file6 = file_path + "relation_norm_50dim_batch75"
    file7 = file_path + "relation_hyper_50dim_batch75"
    file8 = file_path + "test.txt"
    file9 = file_path + "loss_record.txt"
